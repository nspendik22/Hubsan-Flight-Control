...
public class Fly extends Activity implements SensorEventListener, RadioGroup.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener {
    ...
    private static String address = "98:D3:31:20:A0:FE";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Fly.this, sendData.class);
